...
<html>  
    ...
    <body style="width: 100%; margin:0; font-family:'Inter var';">
        ...
        <main>
            <h1 class="text-2xl" style="font-family:'Inter var';">{{ 'Crediteurenoverzicht ' . $report->overview->administration->name }}</h1>
            ...
            <div style="margin-top: 14px;">
                ...
                <table cellspacing="0" cellpadding="1" width="100%" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            @php
                                $cells_to_show = $row->reject(function($cell) use ($report){
